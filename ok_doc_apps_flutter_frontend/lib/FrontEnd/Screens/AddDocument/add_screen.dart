  ...
  void pickFile() async {
    try {
      ...
      if (result != null) {
        ...
        _fileName = 'Document-$docName-$date.$_fileExtension';
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        MaterialButton(
                          ...
                          onPressed: () {
                            if (_documentnameController.text != null &&
                                _organizationnameController.text != null &&
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                  content: Text("One or more input is missing"),
                                  duration: Duration(seconds: 1),
                                ),
                              );
                            }
